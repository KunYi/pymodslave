...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btStartStop = QtGui.QPushButton(self.frame_commands)
        ...
        self.horizontalLayout_5.addWidget(self.btStartStop)
        ...
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(_fromUtf8(":/img/document-import-16.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionLoad_Session.setIcon(icon16)
        self.actionLoad_Session.setObjectName(_fromUtf8("actionLoad_Session"))
        self.actionSave_Session = QtGui.QAction(MainWindow)
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(_fromUtf8(":/img/document-export-16.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSave_Session.setIcon(icon17)
