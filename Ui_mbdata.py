...
#
# Created: Thu Sep 27 15:43:08 2012
...
class Ui_MBData(object):
    def setupUi(self, MBData):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(6, 5, 452, 357))
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/img/DO.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabIOs.addTab(self.tabCoils, icon1, _fromUtf8(""))
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(6, 5, 452, 357))
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/img/DI.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabIOs.addTab(self.tabDiscreteInputs, icon2, _fromUtf8(""))
        ...
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(6, 5, 452, 360))
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/img/AO.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabIOs.addTab(self.tabHoldingRegisters, icon3, _fromUtf8(""))
        ...
        self.verticalLayoutWidget_4.setGeometry(QtCore.QRect(6, 5, 452, 360))
