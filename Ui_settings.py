...
# Form implementation generated from reading ui file 'c:\Projects\python\pyModSlaveQt\ui\settings.ui'
#
# Created: Mon Apr 23 13:14:49 2012
...
class Ui_Settings(object):
    def setupUi(self, Settings):
        ...
        Settings.resize(180, 180)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Maximum, QtGui.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(Settings.sizePolicy().hasHeightForWidth())
        Settings.setSizePolicy(sizePolicy)
        Settings.setMinimumSize(QtCore.QSize(180, 180))
        Settings.setMaximumSize(QtCore.QSize(240, 240))
        icon = QtGui.QIcon()
